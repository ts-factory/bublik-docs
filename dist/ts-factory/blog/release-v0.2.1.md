...
![Login form](/bublik/docs/blog/img/auth.webp)
...
![Profile page](/bublik/docs/blog/img/profile.webp)
...
![Admin](/bublik/docs/blog/img/admin-users.webp)
...
![Runs charts](/bublik/docs/blog/img/runs-charts.webp)

### History expressions

Added expression support for multiple history fields

![History expressions](/bublik/docs/blog/img/history-fields.webp)

### Import logs

Integrated import logs

![Import logs](/bublik/docs/blog/img/import-logs.webp)
