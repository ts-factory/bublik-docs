...
![Small UI Improvements](/bublik/docs/blog/img/reports.webp)

### Config Font Size

![Font Size](/bublik/docs/blog/img/font-size.webp)

### Config Exists

![Config Exists](/bublik/docs/blog/img/exists_config.webp)

### Updated Record Config Header

![Config Header](/bublik/docs/blog/img/report-label.webp)

### Change Dashboard Headers Order

![Change Dashboard Headers Order](/bublik/docs/blog/img/config-header.webp)

### Add Report Argument Labels

![Args](/bublik/docs/blog/img/seq.webp)
