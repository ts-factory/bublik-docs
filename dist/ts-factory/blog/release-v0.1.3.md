...
![Log page tree skipped tests](/bublik/docs/blog/img/SCR-20230318-chrl.webp)

### Added more data to import event table

![Import page table](/bublik/docs/blog/img/SCR-20230318-cjpi.webp)

### New form for importing multiple runs at once

![Import multiple runs at once](/bublik/docs/blog/img/SCR-20230317-hkff.webp)

![Import list results](/bublik/docs/blog/img/SCR-20230317-hlar.webp)
