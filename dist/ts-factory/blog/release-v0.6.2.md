...
![Runs selection](/bublik/docs/blog/img/runs-multiple.webp)

#### Page

![Runs merged page](/bublik/docs/blog/img/multiple-page.webp)

### Reports Button

![Log button](/bublik/docs/blog/img/log-reports-button.webp)

### Log Preview

We've made small redesign adjustment and also added new bug button to preview

![Log Preview](/bublik/docs/blog/img/log-preview.webp)

### New Bug

Small redesign to match new log preview style

![New Bug Drawer](/bublik/docs/blog/img/new-bug-drawer.webp)

### Updated Report Headers

![New Headers](/bublik/docs/blog/img/headers.webp)
