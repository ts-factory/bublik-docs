...
![History reset filters](/bublik/docs/blog/img/history-reset-filters.webp)

### Measurements

We've also added a new page mode for history where you can see values change over time

![History charts](/bublik/docs/blog/img/history-charts.webp)
...
![History charts modal](/bublik/docs/blog/img/history-chart-modal.webp)
...
![Datepicker](/bublik/docs/blog/img/datepicker.webp)

### Date-range picker

![Date range picker](/bublik/docs/blog/img/date-range-picker.webp)
