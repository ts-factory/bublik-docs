...
![Login form](/docs/blog/img/auth.webp)
...
![Profile page](/docs/blog/img/profile.webp)
...
![Admin](/docs/blog/img/admin-users.webp)
...
![Runs charts](/docs/blog/img/runs-charts.webp)

### History expressions

Added expression support for multiple history fields

![History expressions](/docs/blog/img/history-fields.webp)

### Import logs

Integrated import logs

![Import logs](/docs/blog/img/import-logs.webp)
