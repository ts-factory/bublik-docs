...
![Small UI Improvements](/docs/blog/img/reports.webp)

### Config Font Size

![Font Size](/docs/blog/img/font-size.webp)

### Config Exists

![Config Exists](/docs/blog/img/exists_config.webp)

### Updated Record Config Header

![Config Header](/docs/blog/img/report-label.webp)

### Change Dashboard Headers Order

![Change Dashboard Headers Order](/docs/blog/img/config-header.webp)

### Add Report Argument Labels

![Args](/docs/blog/img/seq.webp)
