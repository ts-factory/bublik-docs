...
![Series Charts](/docs/blog/img/series-charts.webp)

### Improved Import

Added "RECIEVED" and "STARTED" import event types support

![Import](/docs/blog/img/import.webp)

### Multiple Expected

Added support for multiple expected results

![Multiple Expected](/docs/blog/img/results.webp)

### Limit axis y values

Added toggle button to limit axis y values for charts

![Limit axis y values](/docs/blog/img/limit.webp)
