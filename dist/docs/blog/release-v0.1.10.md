...
![Button to open toolbar](/docs/blog/img/toolbar-1.webp)

![Opened toolbar](/docs/blog/img/toolbar-2.webp)

### Log time

You can now see time delta relative to selected row if you enable "time delta mode"

![Log delta](/docs/blog/img/delta-1.webp)
...
![Sidebar](/docs/blog/img/sidebar-1.webp)
...
![Import form](/docs/blog/img/import-form-1.webp)
