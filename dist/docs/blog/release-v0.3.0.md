...
![Report Button](/docs/blog/img/report-1.webp)

![Report Page](/docs/blog/img/report-2.webp)

### Copy Short Link

You can shortcut button to copy short link of the current page on right top corner

![Copy Link Button Run Page](/docs/blog/img/copy-1.webp)

![Copy Link Button Runs Page](/docs/blog/img/copy-2.webp)

### Command Menu

We've added command menu with some shortcuts to common actions, pages

![Command](/docs/blog/img/cmd-1.webp)

Also you can copy short link to current page from command menu

![Command Copy](/docs/blog/img/cmd-2.webp)
