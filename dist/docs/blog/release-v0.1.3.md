...
![Log page tree skipped tests](/docs/blog/img/SCR-20230318-chrl.webp)

### Added more data to import event table

![Import page table](/docs/blog/img/SCR-20230318-cjpi.webp)

### New form for importing multiple runs at once

![Import multiple runs at once](/docs/blog/img/SCR-20230317-hkff.webp)

![Import list results](/docs/blog/img/SCR-20230317-hlar.webp)
