...
![Runs selection](/docs/blog/img/runs-multiple.webp)

#### Page

![Runs merged page](/docs/blog/img/multiple-page.webp)

### Reports Button

![Log button](/docs/blog/img/log-reports-button.webp)

### Log Preview

We've made small redesign adjustment and also added new bug button to preview

![Log Preview](/docs/blog/img/log-preview.webp)

### New Bug

Small redesign to match new log preview style

![New Bug Drawer](/docs/blog/img/new-bug-drawer.webp)

### Updated Report Headers

![New Headers](/docs/blog/img/headers.webp)
