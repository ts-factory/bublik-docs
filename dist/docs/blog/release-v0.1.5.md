...
![Reworked sidebar](/docs/blog/img/Capture-2023-06-09-103917.webp)

### New changelog UI

We also added changelog

![New changelog](/docs/blog/img/Capture-2023-06-09-104647.webp)

### Reworked run toolbar

We've moved toolbar with various buttons

![Reworked toolbar](/docs/blog/img/Capture-2023-06-09-104900.webp)

Added ability to hide/show columns via dropdown menu

![Toggle run table columns](/docs/blog/img/Capture-2023-06-09-105115.webp)

### Opening NOK results on link click

You can now go to run with opened results by clicking on NOK with `Ctrl+click`

![Nok results](/docs/blog/img/Capture-2023-06-09-105620.webp)
...
![New log UI](/docs/blog/img/Capture-2023-06-09-110507.webp)
