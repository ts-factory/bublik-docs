...
![History reset filters](/docs/blog/img/history-reset-filters.webp)

### Measurements

We've also added a new page mode for history where you can see values change over time

![History charts](/docs/blog/img/history-charts.webp)
...
![History charts modal](/docs/blog/img/history-chart-modal.webp)
...
![Datepicker](/docs/blog/img/datepicker.webp)

### Date-range picker

![Date range picker](/docs/blog/img/date-range-picker.webp)
