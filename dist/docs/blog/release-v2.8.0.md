...
![Dim Mode Example](/docs/blog/img/dim-1.webp)

![Dim Mode Example](/docs/blog/img/dim-2.webp)
...
![Expected/Unexpected Total Columns Example](/docs/blog/img/columns.webp)
...
![Interrupted Run Status Example](/docs/blog/img/inter-1.webp)

### Reworked Settings

Settings have been redesigned as a modal accessible from the sidebar

![Settings Button](/docs/blog/img/settings-1.webp)

![Settings Modal](/docs/blog/img/settings-2.webp)
...
![Statistics Summary Layout](/docs/blog/img/runs-1.webp)

### Timezone-Aware Date Display

All dates and times throughout the application now should display in your local timezone

![Timezone Alignment](/docs/blog/img/log-1.webp)
